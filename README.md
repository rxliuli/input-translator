...
- **Free by Default** - Uses Google Translate (Microsoft Translator also available), no configuration required
...
**Q: Is it free to use?**
A: Yes! The extension uses Google Translate by default which is free, with Microsoft Translator as a free alternative. OpenAI API is optional.
...
A: The extension supports all languages available in Google Translate, Microsoft Translator, and your configured AI model.
